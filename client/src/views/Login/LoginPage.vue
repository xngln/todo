        ...
        <form @submit.prevent="submit(activeModal)">
         ...
         <div class="login-underline underline" v-if="activeModal === 'Login'" ></div>
          ...
          <div class="field" v-if="activeModal === 'Sign up'">
            ...
            <div class="control">
              <input class="input" v-model="firstName" id="input_first"
          ...
          <div class="field" v-if="activeModal === 'Sign up'">
            ...
            <div class="control">
              <input class="input" v-model="lastName" id="input_last"
          ...
          <div class="field">
            ...
            <div class="control">
              <input class="input" v-model="email" type="email" id="input_email"
          ...
          <div class="field">
            ...
            <div class="control">
              <input class="input" v-model="password" type="password" id="input_password"
